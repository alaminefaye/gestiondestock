...
<div class="page-header">
    <div class="page-block">
        <div class="page-header-title">
            <h5 class="mb-0 font-medium">Modifier Produit</h5>
        </div>
        <ul class="breadcrumb">
                ...
                <form action="{{ route('produits.update, $produit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror" value="{{ old('nom', $produit->nom) }}" required>
                            @error('nom')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-span-12 md:col-span-6">
                            <label class="form-label">Référence <span class="text-danger">*</span></label>
                            <input type="text" name="reference" class="form-control @error('reference') is-invalid @enderror" value="{{ old('reference', $produit->reference) }}" required>
                            @error('reference')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-span-12">
                            <label class="form-label">Description</label>
                            <textarea name="description" rows="3" class="form-control @error('description') is-invalid @enderror">{{ old('description', $produit->description) }}</textarea>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <select name="fournisseur_id" class="form-control @error('fournisseur_id') is-invalid @enderror">
                                ...
                                @foreach($fournisseurs as $four)
                                    <option value="{{ $four->id }}" {{ old('fournisseur_id', $produit->fournisseur_id) == $four->id ? 'selected' : '' }}>{{ $four->nom }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <input type="number" name="prix_achat" step="0.01" class="form-control @error('prix_achat') is-invalid @enderror" value="{{ old('prix_achat', $produit->prix_achat) }}" required>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <input type="number" name="prix_vente" step="0.01" class="form-control @error('prix_vente') is-invalid @enderror" value="{{ old('prix_vente', $produit->prix_vente) }}" required>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <input type="number" name="quantite_stock" class="form-control @error('quantite_stock') is-invalid @enderror" value="{{ old('quantite_stock', $produit->quantite_stock) }}" required>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <input type="number" name="seuil_alerte" class="form-control @error('seuil_alerte') is-invalid @enderror" value="{{ old('seuil_alerte', $produit->seuil_alerte) }}" required>
                        ...
                        <div class="col-span-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="actif" id="actif" value="1" {{ old('actif', $produit->actif) ? 'checked' : '' }}>
